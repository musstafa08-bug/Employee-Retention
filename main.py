...
def index_page():
    """
                                        This method is used to call index html page!!.
...
def training_route_client():
    """
                                        This method is used to call training route!!.
...
def batch_prediction_route_client():
    """
                                        This method is used to call batch prediction route!!.
...
def single_prediction_route_client():
    """
                                        This method is used to call single prediction route!!.
